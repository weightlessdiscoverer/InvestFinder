 ...
 * Automatisch aktualisiert durch dax40FreshnessService (2026-04-12T08:58:49.049Z).
...
const DAX40_STOCKS = [
  { provider: 'DAX40', ticker: 'TICKE.DE', name: 'Company', isin: '', wkn: '' },
  ...
  { provider: 'DAX40', ticker: 'DTG.DE', name: 'Daimler Truck', isin: '', wkn: '' },
  ...
  { provider: 'DAX40', ticker: 'G1A.DE', name: 'GEA Group', isin: '', wkn: '' },
  ...
  { provider: 'DAX40', ticker: 'G24.DE', name: 'Scout24', isin: '', wkn: '' },
